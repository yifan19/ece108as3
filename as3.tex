...
Proof:
\[(x+a)^{n+1} = \sum_{r=0}^{n+1} C((n+1)‚ r)x^{(n+1)-r}a^r\]
\[(x+a)^{n+1} = \sum_{r=0}^{n+1} \frac{(n+1)!}{r!(r-n+1)!}xx^{(n-r)}a^r\]
\[(x+a)^{n+1} = \sum_{r=0}^{n+1} \frac{(n+1)(n)!}{r!(r-n+1)(r-n)!}xx^{(n-r)}a^r\]
\[(x+a)^{n+1} = (n+1)x \sum_{r=0}^{n+1} \frac{(n)!}{r!(r-n+1)(r-n)!}x^{(n-r)}a^r\]
